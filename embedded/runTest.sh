...
#INFINISPAN_HOME=$HOME/Work/jdg

INFINISPAN_COMMITS="t_async_api_change_experiments"
#INFINISPAN_COMMITS="master_before_triangle"
#INFINISPAN_COMMITS="JDG_7.0.0.GA jdg-7.1.x"
#INFINISPAN_COMMITS="JDG-670/replication_read_performance jdg-7.1.x JDG_7.1.0.DR2"
...
BASENAME=$PREFIX-$(date +%Y%m%d-%H%M)-${COMMIT//[^a-zA-Z0-9-_.]/_}
...
for COMMIT in $INFINISPAN_COMMITS; do
  BUILD_DIR=/home/dan/Work/tmpbuild/infinispan-microbenchmarks
  rm -rf $BUILD_DIR
