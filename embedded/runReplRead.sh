...
COMMON_OPTS="-XX:+UseG1GC -Xloggc:gc.log -Djava.net.preferIPv4Stack=true -Dorg.jboss.logging.provider=log4j2"
...
PARAMS="-t $NUM_THREADS -wi $WARMUP_SECONDS -r 6 -i 10 -p jgroupsConfig=$JGROUPS_CONFIG"
...
#INFINISPAN_VERSION=6.4.0-redhat-SNAPSHOT
#run_build
